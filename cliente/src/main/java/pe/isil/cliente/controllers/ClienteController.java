 ...
 */
package pe.isil.cliente.controllers;
...
import pe.isil.cliente.model.AD_Cliente;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(URL == null || URL.equals("/")){
            try {
                ...
                List<Cliente> listado_clientes = new ArrayList<Cliente>();
                listado_clientes = ad_Cliente.getAll();
                
                request.setAttribute("listado_clientes",listado_clientes);
