    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (email.trim() == "" || password.trim() == "") {
                ...
                sesion.setAttribute("mensaje_error", "Por favor ingrese usuario y password");
            ...
            {            
                ...
                //declaramo un objeto y a la vez buscamos el usuario por email
                ...
                {
                    //3. Validar que la contraseña ingresada en el form del login
                    //coincida con la de la base de datos que esta en usuarioecontrado
                    ...
                    if (encriptador.checkPassword(password, usuarioEncontrado.getPassword())) {
                        //si coincide, creamos el la sesion
